...
public class ExtentReportManager {
    ...
    public static ExtentReports createInstance() {
        ...
        // Dinamik dosya adı: src/main/java/exports/reports/TestReport_2026-05-26_16-38-26.html
        String timestamp = new java.text.SimpleDateFormat("-yyyy-MM-dd-HH-mm-ss").format(new java.util.Date());
        String reportPath = "src/main/java/exports/reports/HTMLReports" + timestamp + ".html";
        ...
        extent.setSystemInfo("Tester", "Techno Study");
